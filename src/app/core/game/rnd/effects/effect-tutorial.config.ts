...
export const EFFECT_TUTORIALS: readonly EffectTutorialDefinition[] = [
  ...
  gem(GemEffectType.TIMER, "Timer", "effect-timer", "#ffcf75", "Una scadenza a impulsi.", "Perde un turno a ogni impulso globale.", "Risolvi questa gemma con priorità prima dello scadere del conto alla rovescia."),
