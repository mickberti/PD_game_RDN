...
export const RDN_ACTION_CATALOG: Readonly<Record<RdnActionId, RdnActionDefinition>> = {
  zero: { id: "zero", label: "Azzeramento", description: "Azzera la gemma attiva.", icon: "action-holy-star", charges: 1, cooldownMs: 0, modes: ["adventure", "time-attack", "free"], targeting: "active-flow" },
  recalibrate: { id: "recalibrate", label: "Ricalibra", description: "Ricalibra gli operatori numerici.", icon: "action-heal", charges: 1, cooldownMs: 0, modes: ["adventure", "free"], targeting: "board" },
  ...
  "freeze-time": { id: "freeze-time", label: "Congela tempo", description: "Blocca il timer per 5 secondi.", icon: "action-defense", charges: 1, cooldownMs: 0, modes: ["time-attack"], targeting: "timer" },
};
