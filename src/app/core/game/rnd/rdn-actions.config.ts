...
export const RDN_ACTION_CATALOG: Readonly<Record<RdnActionId, RdnActionDefinition>> = {
  zero: { id: "zero", label: "Azzeramento", description: "Azzera la gemma del flusso attivo.", icon: "action-lightning", charges: 1, cooldownMs: 0, modes: ["adventure", "time-attack", "free"], targeting: "active-flow" },
  invert: { id: "invert", label: "Cambia segno", description: "Inverte il segno della gemma del flusso attivo.", icon: "action-tornado", charges: 1, cooldownMs: 0, modes: ["adventure", "time-attack", "free"], targeting: "active-flow" },
  double: { id: "double", label: "Moltiplica ×2", description: "Raddoppia il valore della gemma del flusso attivo.", icon: "action-holy-star", charges: 1, cooldownMs: 0, modes: ["adventure", "time-attack", "free"], targeting: "active-flow" },
  skip: { id: "skip", label: "Salta flusso", description: "Salta il flusso operativo corrente.", icon: "action-speed", charges: 1, cooldownMs: 0, modes: ["adventure", "time-attack", "free"], targeting: "active-flow" },
};
