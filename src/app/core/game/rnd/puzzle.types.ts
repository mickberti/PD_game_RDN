...
export interface PuzzleState { levelId: string; rotation: number; rotationTurns: number; outerValues: number[]; queueCursors: number[]; impulses: number; rotationSteps: number; history: PuzzleSnapshot[]; won: boolean; }
export interface PuzzleSnapshot { rotation: number; rotationTurns: number; outerValues: number[]; queueCursors: number[]; impulses: number; rotationSteps: number; won: boolean; }
