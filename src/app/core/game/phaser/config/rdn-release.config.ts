...
export type { RdnFeatureFlags, RdnBalanceSnapshot, RdnTelemetryEvent } from "../catalogues/v011/rdn-release.config";
const release = activeRdnCatalogueRuntime.release as typeof import("../catalogues/v011/rdn-release.config");
