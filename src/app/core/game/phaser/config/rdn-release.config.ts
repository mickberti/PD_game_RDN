...
export type { RdnFeatureFlags, RdnBalanceSnapshot, RdnTelemetryEvent } from "../catalogues/v008/rdn-release.config";
const release = activeRdnCatalogueRuntime.release as typeof import("../catalogues/v008/rdn-release.config");
