...
export type { RdnProgressionRule, RdnEffectProgressionRule } from "../catalogues/v011/progression-rules.config";
const progression = activeRdnCatalogueRuntime.progression as typeof import("../catalogues/v011/progression-rules.config");
