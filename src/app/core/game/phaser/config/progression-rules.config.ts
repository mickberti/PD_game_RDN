...
export type { RdnProgressionRule, RdnEffectProgressionRule } from "../catalogues/v009/progression-rules.config";
const progression = activeRdnCatalogueRuntime.progression as typeof import("../catalogues/v009/progression-rules.config");
