...
export type { EffectProgressionMode, EffectProgressionTier, FreeEffectSelections } from "../catalogues/v007/effect-progression.config";
const effects = activeRdnCatalogueRuntime.effects as typeof import("../catalogues/v007/effect-progression.config");
