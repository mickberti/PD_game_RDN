...
export type { EffectProgressionMode, EffectProgressionTier, FreeEffectSelections } from "../catalogues/v009/effect-progression.config";
const effects = activeRdnCatalogueRuntime.effects as typeof import("../catalogues/v009/effect-progression.config");
