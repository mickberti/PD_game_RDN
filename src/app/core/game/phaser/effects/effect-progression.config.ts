...
export type { EffectProgressionMode, EffectProgressionTier, FreeEffectSelections } from "../catalogues/v011/effect-progression.config";
const effects = activeRdnCatalogueRuntime.effects as typeof import("../catalogues/v011/effect-progression.config");
