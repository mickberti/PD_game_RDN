...
const basic = (id: string, title: string, summary: string, behavior: string, strategy: string): EffectTutorialDefinition => ({ id: `BASIC:${id}`, scope: EffectScope.GEM, type: "BASIC", title, iconFrame: "", color: "#ffdf70", summary, behavior, strategy });

export const EFFECT_TUTORIALS: readonly EffectTutorialDefinition[] = [
  basic("RING", "L'anello", "I valori sulle sfere dell'anello sono gli obiettivi da risolvere.", "Porta ogni valore a zero usando le operazioni disponibili sull'ingranaggio.", "Osserva segni e grandezze: ogni flusso deve terminare sulla sfera corretta."),
  basic("GEAR", "L'ingranaggio", "L'ingranaggio contiene le gemme operatore e può ruotare.", "Ruotando l'ingranaggio allinei un operatore con una sfera dell'anello.", "Trascina l'ingranaggio per scegliere quale operatore inviare al prossimo impulso."),
  basic("FLOWS", "I flussi", "I flussi collegano l'impulso alle sfere dell'anello.", "Il flusso principale è verde e indica il bersaglio attivo; i flussi secondari sono gialli e mostrano le propagazioni collegate.", "Segui il percorso colorato prima di confermare l'operazione."),
  basic("IMPULSE", "L'impulso", "L'impulso applica l'operazione allineata.", "Premi il centro dell'impulso per inviare il valore lungo il flusso e aggiornare la sfera.", "Risolvi una sfera alla volta e controlla il nuovo valore dopo ogni impulso."),
  ...
  link(LinkEffectType.CHAIN, "Catena", "effect-chain-link", "#ff6c67", "Un vincolo direzionale tra due gemme.", "La gemma alla destinazione della freccia non riceve impulsi finché l’origine non è a zero.", "Risolvi prima la gemma origine, poi la gemma incatenata."),
