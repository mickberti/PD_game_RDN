...
/** The v010 sphere/mode table is canonical; obsolete checkpoints never override it. */
...
const generateRdnLevelCatalogue = (): readonly LevelDefinition[] => {
  ...
  console.info(`[RDN] Generazione v010: livelli ${firstLevel}-${lastLevel}; modalitÃ  ${modes.join(", ")}; totale ${total}.`);
