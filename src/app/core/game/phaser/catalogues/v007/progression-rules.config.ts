...
export interface RdnProgressionRule {
  ...
  /** Budgets used for levels above the STABLE effect tier. */
...
export const rdnGenerationAttemptsForSpheres = (spheres: number): Pick<RdnProgressionRule, "solutionAttemptsBeforeScaling" | "structureAttemptsBeforeScaling"> => {
